...
function getCallbackUrl()
{
	...
	return "localhost:8080/hugsanddrugs/paymentGateway/response.php";
}
...
<div class="main">
    ...
    <span><input type="text" id="amount" name="amount" placeholder="Amount" value="<?php echo $_GET['amount'];?>" /></span>    
    </div>
    
    <div class="dv">
    <span class="text"><label>Product Info:</label></span>
    <span><input type="text" id="pinfo" name="pinfo" placeholder="Product Info" value="Medicom Medicine" /></span>
    </div>
    ...
    <span><input type="text" id="mobile" name="mobile" placeholder="Mobile/Cell Number" value="<?php echo $_GET['mobile'];?>" /></span>
    </div>
