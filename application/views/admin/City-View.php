...
<div class="row Hospital">
  <div class="col-md-12">
		...
		<center><h3><b>State Information</b></h3></center>
	...
	<tr role="row">
		...
		<th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="First Name: activate to sort column descending">State Name
		</th>

		
		<th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="First Name: activate to sort column descending">City Name
		</th>
