...
<head>
	...
	<link rel="icon" type="image/png" href="<?php echo base_url();?>/client_assets/images/favicon.png">
						...
						<fieldset class="step" id="step1">
							...
							<div class="row">
								...
								<div class="form-group col-md-6">
									...
									<input type="text" name="state_name" id="state_name" class="form-control required" placeholder="Enter State Name" value="<?php echo $state_name;?>" >
								</div>	
